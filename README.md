...
| 이름  | 역할                                                          |
|-----  |-------------------------------------------------------------|
| 윤대성 | 서비스 설계, 데이터 수집·분석, 룰 기반 모델 설계, streamlit 구현, 레포·브랜치 관리, 문서화 |
| 윤승혁 | 내용 정리 및 발표 PPT 제작                                   |
| 최지용 | Streamlit layout 설계 및 구현                                    |
| 한예나 | 웹 크롤링·스크래핑 기반 데이터 수집 파이프라인 구축, DB 구조 설계, Docker 기반 개발 환경 구성 |
...
| 평가자 | 회고 내용                                                                                                                                                                      |
|-----|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 박민선 | 프로젝트 초기부터 주도적으로 진행하며 아이디어를 적극적으로 제시해주셔서 프로젝트가 원활히 진행될 수 있었습니다. 또한 중간중간 진행 상황을 잘 공유해주셔서 프로젝트의 흐름을 빠르게 파악할 수 있었고, 내용을 깔끔하게 정리해주신 덕분에 발표 자료를 수월하게 구성할 수 있었습니다.                                             |
...
| 박민선 | Streamlit을 활용해 직관적인 UI와 시각화 화면을 구현해주신 덕분에 프로젝트의 핵심 결과를 발표 자료에 효과적으로 담아낼 수 있었습니다. 복잡한 데이터가 깔끔하게 시각화되어 있어서 프로젝트의 성과를 한눈에 파악하고 정리하는 데 큰 도움이 되었습니다.                                                                                |
...
| 박민선 | 데이터베이스 구조와 로직을 체계적으로 설계해주신 덕분에 프로젝트의 기술적 흐름을 쉽게 이해하고 발표 자료에도 명확하게 담아낼 수 있었습니다. 헷갈리는 부분 없이 명확한 설계를 바탕으로 프로젝트 중심을 잘 잡아주셔서 큰 도움이 되었습니다.                                                                                                            |
...
| 박민선 |  프로젝트의 필요한 데이터를 위해 API를 조사해주시고 DB에 적재하는 과정까지 맡으셔서 프로젝트의 데이터 수집에 많은 도움이 되었습니다. 또한 프로젝트 전반의 논리를 체계적으로 설계해주신 덕분에 설득력 있는 발표 자료를 구성할 수 있었습니다.                                                                           |
...
| 박민선 |   웹 크롤링과 전처리 과정을 통해 프로젝트에 필요한 양질의 데이터를 확보해주셔서 프로젝트 진행에 많은 도움이 되었습니다. 가장 기초가 되는 데이터가 깔끔하게 정제된 덕분에 프로젝트의 성과와 결과를 명확하게 도출할 수 있었습니다.                                                                                                                                                          |
